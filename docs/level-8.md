...
- As mentioned in the [level 2](level-2.md#the-5-stall-cluing-off-chop-5s5踏步), *5 Stalls* are when a player clues an off chop 5 purely because they want (or need) to give a stall clue.
