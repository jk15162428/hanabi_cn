...
- As mentioned in the [level 2](level-2.md#5踏步The-5-Stall), *5 Stalls* are when a player clues an off chop 5 purely because they want (or need) to give a stall clue.
