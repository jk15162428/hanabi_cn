...
- A *Selfish Clue* is when a player:
  ...
  1. gives a *Play Clue* to the next connecting card (e.g. red 3)
...
- We are only allowed to perform *Save Clues* on specific cards and in specific ways, as outlined in [level 1](level-1.md#save-clues). For example, we all agree that we must save 5's with number 5.
...
- As outlined in the [level 3 strategy section](level-3.md#Tempo节奏), Hanabi is about balancing *Efficiency* and *Tempo*.
