...
- Dark omni cards "inherit" all of the conventions from the base suits (e.g. dark pink conventions, black conventions, omni conventions).
- Gray pink cards "inherit" all of the conventions from the base suits (e.g. dark pink conventions, light pink conventions).
